...
<div id="addDialog" style="padding: 10px;">
	<form id="addForm" method="post">
		<table id="addTable" cellpadding="8">
			...
			<tr>
				<td>备注:</td>
				<td><input id="add_remark" style="width: 255px; height: 180px;" class="easyui-textbox" type="text" name="remark" data-options="multiline:true" /></td>
			</tr>
		</table>
	</form>
</div>
...
<div id="editDialog" style="padding: 10px">
	<form id="editForm" method="post">
		...
		<table id="editTable" border=0 cellpadding="8" >
			...
			<tr>
				<td>备注:</td>
				<td><input id="edit_remark" style="width: 255px; height: 180px;" class="easyui-textbox" type="text" name="remark" data-options="multiline:true" /></td>
			</tr>
		</table>
	</form>
</div>
